...
class AddOrEditActivity : AppCompatActivity() {
    ...
    private fun initDB() {
        ...
        if (intent != null && intent.getStringExtra("Mode") == "E") {
            ...
            input_sn.setText(tasks.sn)
            input_semestre.setText(tasks.semestre)
            input_fecha.setText(tasks.fecha)
    ...
    private fun initOperations() {
        btn_save.setOnClickListener({
            ...
            if (!isEditMode) {
                ...
                tasks.sn = input_sn.text.toString()
               tasks.semestre = input_semestre.text.toString()
                tasks.fecha = input_fecha.text.toString()

                //tasks.semestre = Integer.parseInt(cursor.getString(cursor.getColumnIndex(SEMESTRE)))
